...
```
【场景】某小区客厅内（夜 内）。韦斯·安德森电影风格。现代简约客厅，灰色水泥质感墙壁，暖色调落地灯散射柔光，深灰色布艺沙发。地板浅色木纹。整体氛围安静慵懒。Kodak Vision3胶片质感，Kodachrome暖调低饱和。

【运镜】固定镜头，沙发正后方背面视角。摄影机：Arri Alexa Mini LF + Panavision 27mm Master Prime。光圈f/4。镜头正对沙发背面，与沙发背面平行，相机高度在沙发靠背顶部略高位置。9:16竖屏。严格对称构图，画面中心点对准沙发中央。所有运动严格固定不动，无推拉摇移。

【关键构图说明】深灰色布艺沙发**横向贯穿整个画面底部到中部**，沙发长度明显宽于9:16画面两侧边框，沙发左右两端延伸出画面外。沙发靠背顶部横切画面约1/2高度处。女主@[女主脸部细节图] 坐在沙发前方（相机与沙发之间看不到女主身体），只有头部从沙发靠背正上方中央露出背面——棕色卷发，看不清面部和穿着。画面上半部分是灰色水泥墙壁和暖色落地灯光晕。整体呈现"前景沙发背面+中景女主头部+远景墙壁"的纵深层次。

【动作】
0-1秒：画面建立。沙发横向贯穿画面，女主只从沙发靠背正上方露出头部背面，棕色卷发，看不清面部和穿着。沙发完全遮挡身体。客厅安静，远处微弱时钟滴答声。
